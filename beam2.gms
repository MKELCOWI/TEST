...
*   The colume should never change, meaning we have river run off.
    ...
    HISTPATTERNS(s,b,b,y0,m0)    "If user choses, he can limit the power production to be the same pattern as in the year 2009."
* Objective functions
...
MODEL beam  /   WBALANCE, RESVOL, RESFIXVOL, RESFIXDIS, SEAVOL, RESDISMAX, ELECHEAD, RESVOLMAX, RESVOLMIN, RESVOLCHANGE,
                ...
                CHALOSS, FIELDLOSS, CONSTANTVOLUME, OBJ, HISTPATTERNS/;
